...
Beginner အနေနှင့် Harness ကို model ၏ အပြင်ဘက်က control layer လို့ အရင်မှတ်နိုင်သည်။ Model က "ဘာလုပ်ချင်တယ်" ဆိုတာကို ပြောပြသည်။ Harness က "လုပ်ခွင့်ရှိလား၊ ဘယ် tool နဲ့လုပ်မလဲ၊ log ဘယ်လိုသိမ်းမလဲ၊ risk ကြီးရင် လူကိုမေးမလား" ဆိုတာကို ထိန်းထားပေးသည်။
...
Tool Broker ဆိုတာ model နှင့် tools ကြားက gatekeeper ဖြစ်သည်။ Model က tool ခေါ်ချင်တိုင်း ချက်ချင်း run မလုပ်ဘဲ၊ ထို tool ကို ဒီ user၊ ဒီ task၊ ဒီ permission scope အတွက် ခွင့်ပြုထားသလားဆိုတာကို စစ်ပေးသောအပိုင်းဖြစ်သည်။
...
ဥပမာ User က "deployment logs ကိုစစ်ပြီး error summary ပြောပါ" ဟုမေးသည်ဆိုပါစို့။ Model က log ဖတ်ရန် tool ခေါ်ချင်မည်။ Harness က ထို tool ကိုသုံးခွင့်ရှိမရှိ စစ်မည်။ Destructive command မပါအောင် တားမည်။ Tool result ကို observation အဖြစ်သိမ်းမည်။ Safe retry လုပ်လို့ရလျှင် retry လုပ်မည်။ Risk ကြီးသော action လိုလာလျှင် human approval တောင်းမည်။ ထို့နောက်မှ final answer ကို user ထံပြန်ပေးမည်။

အလွယ် diagram အနေနှင့် Harness flow ကို ဤလိုမြင်နိုင်သည်။
...
→ Retry, human approval, or final answer
```
...
ဒီနေရာတွင် repo ထဲက class name, middleware name, module name များကို အလွတ်မှတ်ရန်မလိုပါ။ Beginner အနေနှင့် "ဒီအစိတ်အပိုင်းက ဘာကိုထိန်းထားသလဲ" ဆိုသောမေးခွန်းကိုသာ အရင်လိုက်ပါ။
...
Policy plane ဆိုတာ Agent ဘာလုပ်ခွင့်ရှိလဲ၊ ဘယ်အချိန်ရပ်ရမလဲ၊ ဘယ်အခြေအနေတွင် replan လုပ်ရမလဲ၊ ဘယ် limit ကိုကျော်လို့မရဘူးလဲဆိုတာကို ထိန်းသော control layer ဖြစ်သည်။
...
ဤစာရင်းကို အလွတ်မှတ်ရန်မလိုပါ။ အဓိကမှတ်ရန်မှာ Browser agent သည် webpage ကိုဖတ်ရုံမဟုတ်ဘဲ click, submit, JavaScript evaluate အထိလုပ်နိုင်သောကြောင့် registry, schema, memory, trajectory, metrics, redaction စသောထိန်းကွပ်မှုများလိုလာခြင်းဖြစ်သည်။
...
Harness safety ကို အလွယ်မှတ်ရန် အောက်ပါအချက်များကို အရင်ကြည့်နိုင်သည်။

- Read-only first
- Tool permission ကို prompt မဟုတ်ဘဲ code/runtime ကစစ်ရန်
- Risk ကြီးသော action များတွင် human approval တောင်းရန်
- Code/browser/shell execution ကို sandbox ထဲတွင် run ရန်
- Tool call တိုင်းအတွက် trace log ထားရန်
- Memory ကို user/thread/session အလိုက်ခွဲရန်
- Tool output ကို trusted instruction မဟုတ်ဘဲ untrusted data အဖြစ်ကိုင်ရန်
...
Agentic AI တွင်လည်းထိုအတိုင်းပင်ဖြစ်သည်။ Loop သည် Agent ကို အလုပ်ဆက်လုပ်စေသည်။ Harness သည် ထိုအလုပ်ကို သတ်မှတ်ထားသောဘောင်ထဲတွင် ထိန်းထားပေးသည်။ နောက်အခန်းများတွင် ကျွန်ုပ်တို့သည် Harness ၏အစိတ်အပိုင်းများဖြစ်သော MCP, Skill, Sub-agent, Prompt Engineering, Context Engineering, Tool Broker, Observability, Safety စသည်တို့ကိုတစ်ခုချင်းစီဖွင့်ကြည့်မည်။
